...
type Payload = {
  ...
  audit: { score: number; pagesAudited: number; createdAt: string } | null;
...
export default function ProposalView({ token }: { token: string }) {
  ...
  const { proposal, lead, audit, googleAudit, findings } = payload;
