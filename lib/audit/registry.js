...
export const auditModules = [
  ...
  // Table stakes. Weighted below the two modules above, because a competent
  // site builder passes most of this for free.
  { id: "seo", label: "On-page SEO", sortOrder: 4, optional: false, requires: [], recommends: [] },
  { id: "conversion", label: "Conversion paths", sortOrder: 5, optional: false, requires: [], recommends: [] },
];
