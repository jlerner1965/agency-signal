...
const SERVICE_HINT = /(service|treatment|therapy|program|procedure|solution|what-we-(do|offer)|our-(work|care)|specialt|practice-area|clinic|care|industr(y|ies)|application|product|sector|capabilit|market(?!ing))/i;
